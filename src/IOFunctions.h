...
inline void Get_Bool(string const& line, string const& param, bool& value)
{
    size_t pos = line.find(":");
    if (pos != string::npos)
    {
...
inline void Get_Vector(string const& line, string const& param, Eigen::Matrix<real, 2, 1>& value)
{
    size_t pos = line.find(":");
    if (pos != string::npos)
    {
...
inline void Get_Vector(string const& line, string const& param, Eigen::Matrix<int, 2, 1>& value)
{
    size_t pos = line.find(":");
    if (pos != string::npos)
    {
...
inline void Get_Vector(string const& line, string const& param, Eigen::Matrix<real, 3, 1>& value)
{
    size_t pos = line.find(":");
    if (pos != string::npos)
    {
...
inline void Get_Vector(string const& line, string const& param, Eigen::Matrix<int, 3, 1>& value)
{
    size_t pos = line.find(":");
    string substr;
    if (pos != string::npos)
...
inline void Get_Array(string const& line, string const& param, vector<real>& value)
{
    size_t pos = line.find(":");
    string substr;
    if (pos != string::npos)
...
inline void Get_Array(string const& line, string const& param, vector<int>& value)
{
    size_t pos = line.find(":");
    string substr;
    if (pos != string::npos)
...
inline void Get_Array(string const& line, string const& param, vector<size_t>& value)
{
    size_t pos = line.find(":");
    string substr;
    if (pos != string::npos)
...
inline size_t index(size_t ii, size_t jj, size_t nii) { return (ii + jj * nii); }
